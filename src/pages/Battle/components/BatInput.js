  ...
  render() {
    ...
    return (
      <div style={{ flex: 1 }}>
        ...
        {data.login ?
          <div style={{ height: 60, background: '#ebebeb', marginTop: 15, position: 'relative', borderRadius: 5 }}>
            <img
              style={{
                height: 40,
                width: 40,
          ...
          <div style={{ display: 'flex', marginTop: 15, display: 'flex', justifyContent: 'space-between' }}>
            <input
              style={{ height: 36, flex: '4 1 auto', fontSize: 18, paddingLeft: 5 }}
              placeholder="github username"
              onChange={this.handleChange}
              value={value}
            />
            <button
              style={{ height: 40, flex: '1 1 auto', marginLeft: 10, fontSize: 18 }}
