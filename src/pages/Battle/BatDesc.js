      ...
      <>
        ...
        <section style={{ margin: '60px 0' }}>
          ...
          <ul style={playerStyle}>
            <BatInput player="One" savePlayer={(data) => this.handleSave("One", data)} />
            <div style={{ width: 20, height: 40 }} />
            <BatInput player="Two" savePlayer={(data) => this.handleSave("Two", data)} />
          </ul>
          {dataOne.login && dataTwo.login &&
            <div style={batBtnStyle} onClick={() => this.props.showFinal(dataOne, dataTwo)}>BATTLE</div>
          }
        </section>
      </>
    );
